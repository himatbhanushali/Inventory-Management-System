...
{
    public partial class PurchaseReportAll : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    ...
                    String dat = "select * from Purchase_Bill where Purchase_Date between #" + d1.Date.ToString("MM/dd/yyyy") + "# and #" + d2.Date.ToString("MM/dd/yyyy") + "#";
                    textBox1.Text=dat;
   ...
   */
        ...
        private void PurchaseReportAll_Load(object sender, EventArgs e)
        {
            textBox1.Hide();
        }
    }
