...
{
    public partial class PurchaseReportParty : Form
    {
        ...
        // SubTitle Font
        private Font InvSubTitleFonthindi = new Font("DevLys 010", 16, FontStyle.Regular);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    String dat = "select * from Purchase_Bill where Purchase_Date between #" + d1.Date.ToString("MM/dd/yyyy") + "# and #" + d2.Date.ToString("MM/dd/yyyy") + "# and Party_Name='" + comboBox1.Text + "'";
                    //textBox1.Text=dat;
                    //dat = "select * from Purchase_Bill";
                    ...
                    con.Open();
                    dataadapter.Fill(ds, "Purchase_Date");
                    // dataadapter.Fill(ds);
                    dataGridView1.DataSource = ds;
                    dataGridView1.DataMember = "Purchase_Date";
                    con.Close();
                }
   ...
   */
        ...
        {// Set Invoice Table:
            ...
            firstvy = CurrentY;
            CurrentY = CurrentY + InvoiceFontHeight;
            g.DrawString("Bill No", InvoiceFont, BlueBrush, xProductID + 5, CurrentY);
        ...
        private void PurchaseReportParty_Load(object sender, EventArgs e)
        {
            string strSql = "Select distinct Party_Name from Purchase_Bill";
            OleDbConnection con = new OleDbConnection(Utility.con);
