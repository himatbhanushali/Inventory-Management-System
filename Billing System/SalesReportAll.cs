...
{
    public partial class SalesReportAll : Form
    {
        ...
        private void SalesReportAll_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String dat = "select * from Bill where Bill_Date between #" + d1.Date.ToString("MM/dd/yyyy") + "# and #" + d2.Date.ToString("MM/dd/yyyy") + "#";
